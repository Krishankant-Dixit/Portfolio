...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Web application that analyzes resumes, extracts skills, and provides improvement suggestions using NLP and AI.',
      technologies: ['Python', 'NLP', 'FastAPI', 'MongoDB', 'React'],
      featured: true,
      githubUrl: 'https://github.com/Krishankant-Dixit',
      liveUrl: '',
      problem: 'Job seekers often struggle to optimize their resumes for ATS systems and specific job requirements. Manual resume review is time-consuming and doesn\'t provide consistent, actionable feedback.',
      solution: 'Built an intelligent resume analysis tool that uses NLP to extract key information, identify skills, analyze formatting, and provide personalized improvement suggestions. The system compares resumes against job descriptions and industry standards.',
      architecture: 'Python backend with NLP libraries for text extraction and analysis, FastAPI for API endpoints, MongoDB for storing resume data and analytics, and React frontend for user interaction. Implements custom algorithms for skill matching and scoring.',
      outcome: 'Created a comprehensive resume analysis platform that helps job seekers improve their resumes. The system provides detailed feedback on content, structure, and ATS compatibility, helping users increase their chances of landing interviews.',
    },
    {
      id: 4,
      title: 'Blog Platform',
